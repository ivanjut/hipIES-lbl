...
# Embedded file name: /Users/ivanjut333/PycharmProjects/HipIES/hipies/library.py
# Compiled at: 2015-08-05 14:50:27
from PySide import QtGui
from PySide import QtCore
from PySide.QtCore import Qt
from PIL import Image
import viewer, os, pipeline, numpy as np
...
class thumbwidgetitem(QtGui.QFrame):
    ...
    def __init__(self, path, parentwindow):
        ...
        if os.path.isdir(path):
            ...
            if os.path.splitext(path)[1] in pipeline.loader.acceptableexts:
